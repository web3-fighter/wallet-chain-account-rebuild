...
type WalletAccountService interface {
	...
	GetBlockByNumber(ctx context.Context, param domain.BlockNumberParam) (domain.BlockResult, error)
	GetBlockByHash(ctx context.Context, param domain.BlockHashParam) (domain.BlockResult, error)
